...
export default function AllCards() {
  return (
    <>
      ...
      <WorkCard projectLink={'https://tech-slangs.vercel.app'} projectName={'Tech Slangs'} status='Completed' bodyText={'A dictonary of Tech Terms made by you.'} tech={'Nextjs Prisma AuthJs'} />
