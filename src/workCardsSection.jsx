...
export default function AllCards() {
  return (
    <>
      ...
      <WorkCard projectLink={'https://github.com/techslangs'} projectName={'Tech Slangs'} status='In Progress' bodyText={'A dicteonary of Tech Terms made by you.'} tech={'Nextjs Prisma'} />
    </>
  )
